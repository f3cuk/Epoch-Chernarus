	...
	if(_lockable > 1) then {
		...
		call {
			if(_lockable == 2) exitWith { // 2 lockbox
				...
				call {
					if (_combination_1 == 100) exitWith { _combination_1_Display = "Red"; };
					if (_combination_1 == 101) exitWith { _combination_1_Display = "Green"; };
					if (_combination_1 == 102) exitWith { _combination_1_Display = "Blue"; };
				};
