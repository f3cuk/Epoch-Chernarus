class Life_RscScrollBar
{
	...
	thumb = "custom\gold_coins\gui\thumb_ca.paa";
	arrowEmpty = "custom\gold_coins\gui\arrowEmpty_ca.paa";
	arrowFull = "custom\gold_coins\gui\arrowFull_ca.paa";
	border = "custom\gold_coins\gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "custom\gold_coins\gui\expandedTexture_ca.paa";
	hiddenTexture = "custom\gold_coins\gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "custom\gold_coins\gui\normal_ca.paa";
	animTextureNormal = "custom\gold_coins\gui\normal_ca.paa";
	animTextureDisabled = "custom\gold_coins\gui\normal_ca.paa";
	animTextureOver = "custom\gold_coins\gui\over_ca.paa";
	animTextureFocused = "custom\gold_coins\gui\focus_ca.paa";
	animTexturePressed = "custom\gold_coins\gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "custom\gold_coins\gui\main\normal_ca.paa";
	animTextureDisabled = "custom\gold_coins\gui\main\disabled_ca.paa";
	animTextureOver = "custom\gold_coins\gui\main\over_ca.paa";
	animTextureFocused = "custom\gold_coins\gui\main\focus_ca.paa";
	animTexturePressed = "custom\gold_coins\gui\main\down_ca.paa";
	animTextureDefault = "custom\gold_coins\gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "custom\gold_coins\gui\slider\arrowEmpty_ca.paa";
	arrowFull = "custom\gold_coins\gui\slider\arrowFull_ca.paa";
	border = "custom\gold_coins\gui\slider\border_ca.paa";
	thumb = "custom\gold_coins\gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "custom\gold_coins\gui\arrow_left_ca.paa";
	nextPage = "custom\gold_coins\gui\arrow_right_ca.paa";
	shadow = 2;
...
class Life_RscCombo {
	...
	arrowFull = "custom\gold_coins\gui\arrowFull_sca.paa";
	arrowEmpty = "custom\gold_coins\gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
