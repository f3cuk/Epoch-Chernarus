...
class RscTitles 
{
	class Coins {
	    ...
	    fadeout 	= 0;
	    fadein 		= 0;
		onLoad 		= "uiNamespace setVariable ['DAYZ_GUI_COINS_display',_this select 0]";
		duration 	= 10e10;
		name		= "CoinGUI";
		controlsBackground[] = {};
		objects[] = {};
		class controls {
			class CoinsBalance:RscStructuredText {
				idc = 1;
				style = 0;
				size = 0.04;
				text = "";
	...
	class playerStatusGUI {
        ...
        class ControlsBackground {
            ...
            {
                idc = 1307;
                text = "custom\updated_gui\gui\status\st_humanity_survivor.paa";
            ...
            {
                idc = 1309;
                text = "custom\updated_gui\gui\status\st_humanity_bandit.paa";
            ...
            {
                idc = 1310;
                text = "custom\updated_gui\gui\status\zombie.paa";
