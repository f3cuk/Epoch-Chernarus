private ["_vehicle","_args","_servicePoint","_costs","_updateInterval","_amount","_type","_name","_textMissing","_player_money","_repair_cost","_needed"];
...
if !([player,_costs select 1] call fnc_removeCoins) then {
