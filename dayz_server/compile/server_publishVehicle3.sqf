...
[_object,_uid,_characterID,_class,_dir,_location,_donotusekey,_activatingPlayer] spawn {
   ...
   _done = false;
	...
	/*
		call {
			if (_class == "SUV_Pink_DZE4")			exitWith {_object setVehicleInit 'this setObjectTexture [0, ''custom\textures\suvKTY_overlay.jpg''];';};
			if (_class == "SUV_Silver_DZE4")		exitWith {_object setVehicleInit 'this setObjectTexture [0, ''custom\textures\suvUSA_overlay.jpg''];';};
		};
	*/
