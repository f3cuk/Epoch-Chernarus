...
if (!isNull _playerObj) then {
	...
	if ((_timeout - time) > 0) then {
		...
		diag_log format["COMBAT LOGGED: %1 (%2) at location %3 - DEBUG: Weapons: ( %4 - %5) / Magazines: (%6 - %7) / Backpack: (%8) / Money: (%9)",_playerName,_timeout,(getPosATL _playerObj),_weapons,_weapons_backpack,_magazines,_magazines_backpack,_backpack,_money];
