if (isServer) then {
  ...
  //Bandit Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\bandit.sqf";
  //Bilgrad City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\bilgrad.sqf";
  //Branibor City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\branibor.sqf";
  //Hero Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\hero.sqf";
  //Lyepenstok City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\lyepestok.sqf";
  //Misc. Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\miscvendors.sqf";
  //Sabina City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\sabina.sqf";
  //Wholesalers
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Epoch_Zombieland.Tavi\wholesalers.sqf";
